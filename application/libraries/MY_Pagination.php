...
class MY_Pagination extends CI_Pagination {
	...
	function getPageLink($base_url, $total_rows, $per_page, $uri_segment=3) {
		...
		if  ($this->prev_link !== FALSE AND $this->cur_page != 1)
		{
			...
			{
				$output .= $this->prev_tag_open.'<a '.$this->anchor_class.'href="'.$this->first_url.'" ' . $anchorClass . '>'.$this->prev_link.'</a>'.$this->prev_tag_close;
			}
			else
			{
				$i = ($i == 0) ? '' : $this->prefix.$i.$this->suffix;
				$output .= $this->prev_tag_open.'<a '.$this->anchor_class.'href="'.$this->base_url.$i.'" ' . $anchorClass . '>'.$this->prev_link.'</a>'.$this->prev_tag_close;
			}
		...
		if ($this->next_link !== FALSE AND $this->cur_page < $num_pages)
		{
			...
			$output .= $this->next_tag_open.'<a '.$this->anchor_class.'href="'.$this->base_url.$this->prefix.$i.$this->suffix.'" ' . $anchorClass . '>'.$this->next_link.'</a>'.$this->next_tag_close;
		}
