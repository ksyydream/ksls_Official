<form id="pagerForm" method="post" action="<?php echo site_url('manage/list_ticket')?>">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="delete" href="<?php echo site_url('manage/delete_ticket')?>/{id}" target="ajaxTodo"  title="确定要删除？" warn="请选择一条记录"><span>删除</span></a></li>
			<li><a class="edit" href="<?php echo site_url('manage/edit_ticket/{id}')?>" target="navTab" rel="edit_ticket" warn="请选择一条记录" title="查看"><span>查看</span></a></li>
		</ul>
	</div>
