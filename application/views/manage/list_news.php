...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <?php if($this->session->userdata('permission_id') == 1 || in_array(4,$this->session->userdata('position_id_array')))  : ?>
            ...
            <?php endif ?>
            <li><a class="edit" href="<?php echo site_url('manage/edit_news/{id}')?>" target="navTab" rel="edit_news" warn="请选择一条记录" title="查看"><span>查看</span></a></li>
        </ul>
    </div>
